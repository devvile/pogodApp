      ...
      <div className="text-center max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-slate-300 mb-6 max-w-lg mx-auto leading-relaxed">
            Looks like this location has drifted off our weather map. The page
            you're looking for doesn't exist.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <BackButton variant="outlined" action="back" className="mb-0" />
          <BackButton variant="filled" action="home" className="mb-0" />
        </div>
      </div>
    </ContentCard>
  );
